...
function getData() {
  for (let i = 0; i < data.length; i++) {
    list.innerHTML += `<div class="flex flex-col items-center justify-center  w-[250px] md:my-10 md:mx-10 my-5 mx-5 p-5 rounded-lg bg-[rgb(249,249,249)] transition ease-in-out delay-150 hover:-translate-y-1 duration-300 ">
