...
<html lang="en">
  ...
  <body>
    ...
    >
      ...
      >
        <img
          ...
          class="md:w-36 md:h-36 hidden md:block"
        ...
        <div class="text-center md:px-2 lg:px-2">
          ...
          <span class="text-lg md:text-xl lg:text-2xl text-blue-900 font-bold"
            >[SATHM]</span
          >
          <p
        ...
        <img
          src="../src/assest/Logo/sathm_logo_without_background.png"
          alt="SATHM Logo"
          class="md:w-40 md:h-40 hidden md:block"
        />
      </div>
    </div>
    ...
    >
      ...
      >
        <li>
          <a href="./index.php" class="hover:text-blue-700 hover:underline"
            >Home</a
          >
        </li>
        <li>
          <a href="./about.php" class="hover:text-blue-700 hover:underline"
            >About</a
          >
        </li>
        <div
        ...
        <li>
          <a href="./faculties.php" class="hover:text-blue-700 hover:underline"
            >Faculties</a
          >
        </li>
        <li>
          <a href="./events.php" class="hover:text-blue-700 hover:underline"
            >Events & Activities</a
          >
        </li>
        <li>
          <a href="./corporate.php" class="hover:text-blue-700 hover:underline"
            >Corporate Linkages</a
          >
        </li>
        <li>
          <a href="./mous.php" class="hover:text-blue-700 hover:underline"
            >MOUs</a
          >
        </li>
      </ul>
    ...
    <div class="md:hidden drawer " >
      ...
      >
        ...
        <ul class="p-4 space-y-6 bg-[#f7f7f7]">
          ...
          <li>
            <a href="./faculties.php" class="flex items-center"
              ><i class="fas fa-users mr-3"></i>Faculties</a
            >
          </li>
          <li>
            <a href="./events.php" class="flex items-center"
              ><i class="fas fa-calendar-alt mr-3"></i>Events & Activities</a
            >
          </li>
          <li>
            <a href="./corporate.php" class="flex items-center"
              ><i class="fas fa-industry mr-3"></i>Corporate Linkages</a
            >
          </li>
          <li>
            <a href="./mous.php" class="flex items-center"
